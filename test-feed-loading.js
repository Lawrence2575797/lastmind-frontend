...
const ctx={console:{error(){}},fetchScheduleData:async()=>[],sfComputeFolderRecommendation:async()=>({node:{label:'Observation'}}),sfBuildSlidesForRecommendation:()=>new Promise(r=>release=r),sfAppendBuiltSlides(){appended=true},sfRefreshImmediateRecalls(){}};
